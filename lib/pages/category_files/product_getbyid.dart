...
class ProductGetById extends StatefulWidget {
  const ProductGetById({super.key, required this.itemId});
  final String itemId;

  @override
  State<ProductGetById> createState() => _ProductGetByIdState();
}

class _ProductGetByIdState extends State<ProductGetById> {
